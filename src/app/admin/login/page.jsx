...
export default function AdminLoginPage() {
  ...
  return (
    <div className="admin-shell flex min-h-screen items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
      <div className="relative w-full max-w-5xl overflow-hidden rounded-xl border border-white/8 bg-white/[0.02] shadow-[0_40px_120px_hsl(220_45%_2%_/_0.46)]">
        ...
        <div className="relative grid min-h-[720px] lg:grid-cols-[1.05fr_0.95fr]">
          <section className="flex flex-col justify-between border-b border-white/8 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
            ...
            <div className="grid gap-4 pt-10 sm:grid-cols-2">
              ...
              <div className="admin-panel-subtle rounded-xl p-5">
          ...
          <section className="flex items-center p-4 sm:p-6 lg:p-8">
            <Card className="admin-panel w-full rounded-xl border-white/10 text-[hsl(var(--admin-foreground))] shadow-none">
              <CardHeader className="space-y-4 border-b border-white/8 p-6 sm:p-7">
                <div className="admin-panel-muted flex h-12 w-12 items-center justify-center rounded-lg text-[hsl(var(--admin-highlight))]">
              ...
              <CardContent className="p-6 sm:p-7">
                {error ? (
                  <div className="mb-5 rounded-lg border border-[hsl(var(--admin-danger)/0.28)] bg-[hsl(var(--admin-danger)/0.12)] px-4 py-3 text-sm text-[hsl(var(--admin-danger))]">
                    {error}
                  </div>
                ) : null}
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={`admin-input h-12 rounded-lg border-white/10 px-4 ${
                        errors.email
                  ...
                  <Button
                    type="submit"
                    className="h-12 w-full rounded-lg border border-[hsl(var(--admin-highlight)/0.2)] bg-[hsl(var(--admin-foreground))] text-[hsl(var(--admin-background-deep))] hover:bg-[hsl(var(--admin-highlight-soft))]"
                    disabled={isLoading}
                  >
                ...
                <div className="mt-5 rounded-lg border border-white/8 bg-white/[0.03] px-4 py-3 text-sm leading-6 text-[hsl(var(--admin-muted))]">
