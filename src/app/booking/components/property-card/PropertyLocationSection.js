...
export function PropertyLocationSection({ control, index }) {
  return (
    <div>
      <p className="block text-xs font-medium uppercase tracking-wider text-muted-foreground mb-3">
        LOCATION
      </p>
            ...
            render={({ field, fieldState }) => {
              ...
              return (
                <div className="flex flex-col gap-1.5">
                  <label
                    htmlFor={fieldId}
                    className="flex items-center gap-1.5 text-2xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5"
                  >
