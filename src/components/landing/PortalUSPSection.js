            ...
            <div className="relative bg-card border border-border rounded-2xl overflow-hidden shadow-2xl">
              <div className="flex border-b border-border">
                {["Bookings", "Files", "Invoices"].map((tab, i) => (
                  <button
                    type="button"
                    key={tab}
                    className={`flex-1 py-3 px-4 text-sm font-medium ${i === 0 ? "bg-secondary/50 border-b-2 border-accent" : "text-muted-foreground"} pointer-events-none`}
                  >
                    {tab}
                  </button>
                ))}
              ...
              <div className="p-6 space-y-4">
                <div className="bg-secondary/50 rounded-xl p-4">
                  ...
                  <div className="flex gap-2 mt-3">
                    <Button
                      size="sm"
                      variant="outline"
                      className="text-xs rounded-lg pointer-events-none"
                    >
                      Reschedule
                    </Button>
                    <Button
                      size="sm"
                      variant="outline"
                      className="text-xs rounded-lg text-destructive pointer-events-none"
                    >
                      Cancel
                    </Button>
                  </div>
                ...
                <div className="bg-secondary/30 rounded-xl p-4">
                  ...
                  <Button
                    size="sm"
                    className="mt-3 rounded-lg bg-accent text-accent-foreground hover:bg-accent/90 pointer-events-none"
                  >
                    Download Files
                  </Button>
                </div>
          ...
          >
            ...
            <ul className="space-y-4 mb-8">
              {features.map((feature) => (
                <li
                  key={feature.text}
                  className="flex items-center gap-4 text-sm lg:text-lg"
                >
