...
models.Transaction.belongsTo(models.Coupon, { foreignKey: "couponId", as: "coupon" });
...
models.Booking.belongsTo(models.Transaction, { foreignKey: "transactionId", as: "transaction" });
...
models.User.hasMany(models.WalletTransaction, { foreignKey: "userId", as: "walletTransactions" });
models.User.hasMany(models.Booking, { foreignKey: "userId", as: "bookings" });

// Transaction has many bookings
models.Transaction.hasMany(models.Booking, { foreignKey: "transactionId", as: "bookings" });

// Coupon has many transactions
models.Coupon.hasMany(models.Transaction, { foreignKey: "couponId", as: "transactions" });