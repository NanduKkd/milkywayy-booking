...
| Booking handoff | Preparation and handoff smoke coverage | 13 | 42 | Admin booking preparation, nullable customer snapshots, locked OTP sent-state behavior, replacement links, and WhatsApp opt-in behavior stay enforced. |
